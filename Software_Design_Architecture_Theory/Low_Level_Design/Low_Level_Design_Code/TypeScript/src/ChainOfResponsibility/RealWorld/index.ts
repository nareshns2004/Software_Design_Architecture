...
/**
 * The AuthenticationHandler interface declares a method for authenticating an
 * HTTP request.
 */
...
/**
 * The AuthenticationRequest represents an HTTP request that needs to be
 * authenticated
 */
...
/**
 * The AuthenticationResult represents the result of an authentication attempt
 */
