...
![web_crawler_example](images/web_crawler_example.png)
...
<p><b>Candidate</b>: What is the main purpose of the crawler? Is it used for search engine indexing, data mining, or something else?</p>
<p><b>Interviewer</b>: Search engine indexing.</p>

<p><b>Candidate</b>: How many web pages does the web crawler collect per month?</p>
<p><b>Interviewer</b>: 1 billion pages.</p>

<p><b>Candidate</b>: What content types are included? HTML only or other content types such as PDFs and images as well?</p>
<p><b>Interviewer</b>: HTML only.</p>

<p><b>Candidate</b>: Shall we consider newly added or edited web pages?</p>
<p><b>Interviewer</b>: Yes, we should consider the newly added or edited web pages.</p>

<p><b>Candidate</b>: Do we need to store HTML pages crawled from the web?</p>
<p><b>Interviewer</b>: Yes, up to 5 years</p>

<p><b>Candidate</b>: How do we handle web pages with duplicate content?</p>
<p><b>Interviewer</b>: Pages with duplicate content should be ignored.</p>
...
![web_crawler_workflow](images/web_crawler_workflow.png)
...
![download_queue](images/download_queue.png)
...
![mapping_table](images/mapping_table.png)
...
![back_queue](images/back_queue.png)
...
![distributed_crawl](images/distributed_crawl.png)
...
![extendable_crawler](images/extendable_crawler.png)
