...
<p><b>Candidate</b>: What are the important features?</p>
<p><b>Interview</b>: A user can publish a post and see her friends’ posts on the news feed page.</p>

<p><b>Candidate</b>: Is the news feed sorted by reverse chronological order or any particular order such as topic scores? For instance, posts from your close friends have higher scores.</p>
...
![publication](images/publication.webp)
...
<b>Fanout on write.</b> With this approach, news feed is pre-computed during write time. A new post is delivered to friends’ cache immediately after it is published.
...
<b>Fanout on read.</b> The news feed is generated during read time. This is an on-demand model. Recent posts are pulled when a user loads her home page.
...
![fanout_service](images/fanout_service.png)
